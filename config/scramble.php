...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'API de integración bidireccional entre Control Escolar y CYPHER Learning NEO LMS v3. Gestiona sincronización de alumnos, docentes, inscripciones, calificaciones y analítica académica.',
    ],
    ...
    'middleware' => [
        'web',
        ...(env('APP_ENV') === 'local' ? [] : [RestrictedDocsAccess::class]),
    ],
