...
return [
    ...
    'defaults' => [
        ...
        'scanOptions' => [
             ...
             *
             * L5Swagger's default analyser only wires up AttributeAnnotationFactory (native PHP
             * attributes), so PHPDoc-style `@OA\...` annotations are silently ignored unless we
             * also register DocBlockAnnotationFactory here (requires doctrine/annotations).
             *
             * @see OpenApi\scan
             */
